...
%
% VERSION NUMBER: 3.06.9 (13th December, 2017)
%
% References
...
for Iprofile = 1:number_of_profiles
    ...
    if any(N2 <= 0)
        try
            if exist('tomlabVersion') == 2 | ...
                    (license('checkout', 'Optimization_Toolbox') == 1 & datenum(matlab_release_date) < 736574 & pl < 2000) | ...
                    exist('cplexqp.p') == 6
            ...
            % continue without stabilising, the next sction will deal with
            % this case.
        end
    end
    ...
    if all(N2 > 0)
        ...
        intergral_N2_all = pchip(p_tmp,intergral_N2,p_all);
